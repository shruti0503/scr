...
class ScrapeConfig {
        ...
        if (options.format_options) {
            options.format_options.forEach((flag) => {
                if (!Object.values(FormatOption).includes(flag)) {
                    throw new errors_js_1.ScrapeConfigError(`Invalid FormatOption param value: ${flag}`);
                }
            });
        }
        if (options.screenshot_flags) {
            options.screenshot_flags.forEach((flag) => {
                if (!Object.values(ScreenshotFlags).includes(flag)) {
                    throw new errors_js_1.ScrapeConfigError(`Invalid ScreenshotFlags param value: ${flag}`);
                }
            });
        }
    ...
    toApiParams(options) {
        ...
        if (this.extraction_template && this.extraction_ephemeral_template) {
            throw new errors_js_1.ScrapeConfigError('You cannot pass both parameters extraction_template and extraction_ephemeral_template. You must choose');
        }
